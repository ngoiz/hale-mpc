...
case_name = 'test__simple_HALE_elevator_alphatrim'
...
# elevator deflection
path_to_elevator_deflection = cases_folder + '/elevator.txt'
time_elevator = 4 # s
elev_perturbation = -1 # deg
elevator_deflection = np.ones(n_tstep) * cs_deflection
end_idx = int(time_elevator/dt)
elevator_deflection[5:5+end_idx] += elev_perturbation * np.pi/180
np.savetxt(path_to_elevator_deflection, elevator_deflection)
...
def generate_solver_file():
    ...
    settings['AerogridLoader'] = {'unsteady': 'on',
                                  ...
                                  'control_surface_deflection_generator_settings': {'0': {
                                      'dt': dt,
                                      'deflection_file': path_to_elevator_deflection,
                                  }},
                                  }
    ...
    settings['DynamicCoupled'] = {'structural_solver': solver,
                                  ...
                                  'final_relaxation_factor': 0.3,
                                  'n_time_steps': n_tstep,
                                  'dt': dt,
                                  'include_unsteady_force_contribution': 'on',
                                  'postprocessors': ['BeamLoads', 'StallCheck', 'WriteVariablesTime',
