...
case_name = 'simple_HALE_freqresp_uvlm'
...
# for m = 16 only
input_vec = np.zeros((n_tstep, num_modes * 3 + 4))
x0 = np.zeros(10)
...
def generate_aero_file():
    ...
    control_surface_chord[0] = m // 2 # m
    control_surface_hinge_coord[0] = 0 #-0.25 # nondimensional wrt elastic axis (+ towards the trailing edge)
