...
if rom:
    modal = True
    case_name += '_rom{:g}'.format(rom)

if modal:
    case_name += '_nmodes{:g}'.format(num_modes)
# FLIGHT CONDITIONS
...
def generate_solver_file():
    ...
    if not modal:
        settings['LinearAssembler']['linear_system_settings']['beam_settings']['modal_projection'] = 'off'
        settings['LinearAssembler']['linear_system_settings']['beam_settings']['inout_coords'] = 'nodes'
...
print('Created {:s}'.format(cases_folder + '/' + case_name))